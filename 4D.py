...
oks = []
id = []
print 'AUTHOR : MX FAHIM VAU'
print 'FACEBOOK :ALONE.KING.OFF.QUEEN'
print 'GITHUB : EAGLE HACKER SQUAD'
CorrectUsername = 'Fuck You'
CorrectPassword = 'Sexy Bom'
loop = 'true'
while loop == 'true':
    ...
    if username == CorrectUsername:
        ...
        os.system('xdg-open https://www.facebook.com/ALONE.KING.OFF.QUEEN')

name = raw_input('\x1b[1;92m\x1b[1;92m Enter Your Name: ')
os.system('xdg-open https://www.facebook.com/ALONE.KING.OFF.QUEEN/?ref=share')
